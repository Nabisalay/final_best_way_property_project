...
// this is form validation of contact seller   

// $(document).ready(function() {

//   function schedule_form_validation(){
//     const first_name = document.querySelector("#contact-seller-first-name");
//     const last_name = document.querySelector("#contact-seller-last-name");
//     const email_address = document.querySelector("#contact-seller-email");
//     const phone_number = document.querySelector("#contact-seller-number");
//     const message = document.querySelector("#contact-seller-message");
...
// const form_container = document.querySelector("#contact-seller-form");
// if (form_container) {
//   // run code that references form_container
//   form_container.addEventListener("submit", function(event) {
//     event.preventDefault(); // prevent the default form submission
...
// this is form validation of contact seller end 

// this is form validation of contact us page

// $(document).ready(function() {

//   function contactpg_form_validation(){
//     const first_name = document.querySelector("#contact-pg-form-name");
//     const email_address = document.querySelector("#contact-pg-form-email");
//     const contact_subject = document.querySelector("#contact-pg-form-subject");
//     const message = document.querySelector("#contact-pg-form-message");
...
//       email_address.focus();
//       return false ;
//     }else if(!message_Validation.test(contact_subject.value.trim())){
//       contact_subject.style.border = "1px solid red"
//       contact_subject.previousElementSibling.innerText = "Please enter a subject of at least one sentence with full stop or coma*"
//       contact_subject.previousElementSibling.style.color = "red"
//       contact_subject.focus();
//       return false ;
//     }else if(!message_Validation.test(message.value.trim())){
//       message.style.border = "1px solid red"
//       message.previousElementSibling.innerText = "Please enter a message of at least one sentence with full stop or coma*"
//       message.previousElementSibling.style.color = "red"
//       message.focus();
//       return false ;
//     }else {
...
//             // this is for contact_subject 
//             contact_subject.style.border = "none"
//             contact_subject.previousElementSibling.innerText = "Enter a subject*"
//             contact_subject.previousElementSibling.style.color = "#4F4E4E"
...
// const form_container = document.querySelector("#contact-us-pg-form");
// if (form_container) {
//   // run code that references form_container
//   form_container.addEventListener("submit", function(event) {
//     event.preventDefault(); // prevent the default form submission
//     contactpg_form_validation() // call the form validation function
//   });
...
$('.view-profile').on('click', function(e) {
  ...
  $('#exampleModal .modal-body p').text(description);
});
...
function rateStars(starNumber) {
  ...
  //   let name = document.querySelector('#review-name');
  //   let status = document.querySelector("#review-status");
  //   let description = document.querySelector('#review-description');
  //   // let ratingStars = document.querySelectorAll('.rating i.fas');
  //   let ratingValue = stars.length;
  //   let imgInput = document.querySelector('#review-img');
  //   let img = document.querySelector('#review-img-preview');

  //   console.log(selectedStars + imgInput);
...
function allcollection() {
  ...
  Array.from(cardbody).forEach(function (element) {
    ...
    // // JavaScript to show and hide loading animation
