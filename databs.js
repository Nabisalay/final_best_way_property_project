...
$(document).ready(function (){ 
  ...
  //
  if (currentUrl.indexOf('index.html') > -1  || currentUrl.indexOf('properties.html') > -1 || currentUrl.indexOf('properties-details.html') > -1){
...
// laodmore_properties(message)

  // const client_reiview_data = [
  //     {
  //       image: "./PICS/team member 1.jpg",
  //       name: "Shirley John",
  //       status: "Happy Seller",
  //       review: "A paragraph with a floating image. A paragraph with a floating image. A paragraph with a Lorem ipsum, dolor sit amet consectetur adipisicing elit. Harum, natus.",
  //     },
  //     {
  //       image: "./PICS/team member 1.jpg",
  //       name: "Shirley John",
...
// this is for the search option of properties page 
  ...
  // saved work for restoration purpose 
  // this is for all collection properties  
// $(document).ready(function (){ 
//   const main_data_base = fetch('database.php')
//   .then(response => response.json())
...
if (matchCount === 0) {
  ...
  // Get all the elements on the page with the class `card-p`.
  ...
  //   if (!property.status === 'sale') {
  //     // Show the card.
  //     cardbody[a].style.display = 'none';
  //   }else{
  //     cardbody[a].style.display = 'block';
...
// $(document).ready(function() {
//   // Retrieve autocomplete suggestions from your data source (e.g., an array or API)
//   const main_data_base = fetch('database.php')
//   .then(response => response.json())
// .then(data => { 
//   // var data = ["Apple", "Banana", "Cherry", "Durian", "Elderberry"];

//   // Initialize Typeahead on the search input field
